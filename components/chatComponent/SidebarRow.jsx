    ...
    <div className="flex cursor-pointer group border-b  py-2 sm:px-3 sm:space-x-7">
      <div className="flex items-center  space-x-3">
        ...
        <div className=" flex-col ">
          <h1 className="text-base font-medium group-hover:text-blue-500 hidden sm:inline-flex">
            {user?.firstname}
          </h1>
      ...
      <div>
        <h1 className="text-sm font-medium hidden lg:inline-flex group-hover:text-blue-500">
          Date
        </h1>
      </div>
    </div>
