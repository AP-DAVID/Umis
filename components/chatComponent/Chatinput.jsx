import { AdjustmentsIcon, CameraIcon, ChevronDoubleRightIcon, EmojiHappyIcon } from "@heroicons/react/solid"
import { useState } from "react";
import Sendmodal from "./Sendmodal";



function Chatinput({newMessage, setNewMessage, handleSubmit, setPicture}) {
    ...
    return (
        <div className=" flex flex-col justify-end h-full w-full py-3">
            ...
            {showModal && (<Sendmodal setShowModal={setShowModal} image={image} setPicture={setPicture}/>)}
            ...
            <div className=" w-full  rounded-l-full rounded-r-full items-center h-14 bg-gray-300 px-2 flex justify-between">
                ...
                <div className="flex h-full space-x-3 w-full">
                    ...
                    <div className="w-full h-full">
                        <textarea type="text" onChange={(e) => setNewMessage(e.target.value)}
                            value={newMessage} className="w-full px-2 py-1 h-full rounded-md" placeholder="Type a Message"  />
