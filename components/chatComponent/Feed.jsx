...
function Feed({handleSubmit, setNewMessage, newMessage, messages, user, setPicture}) {
    ...
    return (
        ...
        <footer className="">
            <Chatinput setPicture={setPicture} newMessage ={newMessage} setNewMessage = {setNewMessage} handleSubmit={handleSubmit}/>
        </footer>
