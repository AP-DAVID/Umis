...
function BlogCard({title, id, profile, body, userId, date, text, position, username, lastname, image}) {
                                    ...
                                    <div>
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <div className="w-full">
                                                    <div className="text-sm flex space-x-2 justify-end align-middle font-medium">
                                                       ...
                                                       { 
                                                         profile ? (
                                                             <img src={profile} className="h-9 w-9 object-cover rounded-full flex"/>
                                                         ) : (
                                        ...
                                        <div className=" flex justify-end ">
                                            <h1 
                                                className={
                                                    (
                                                        username === "Akintola" ? "bg-blue-500 " : "bg-green-500 "
