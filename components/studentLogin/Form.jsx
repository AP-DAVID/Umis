...
const handleSubmit = async(e) =>{
    ...
    if( form.username !== '' && form.password !== ''){
      ...
      try{
        ...
        const response = await axios.post('/api/login/student', JSON.stringify(form) , config)
        ...
        if(response.data === "User not found"){
          ...
          setOpen(false)
            ...
            await signIn("student-login", {username: form.username, password : form.password})
    ...
    return (
        <div className="h-full">
            ...
            m   <div className="flex justify-center">
                ...
                <div className="flex">
                  <input type={eye ? "text" : "password"} placeholder="Password" name="password" value={form.password} onChange={handleChange}  className="px-5 h-14 w-4/5 sm:w-72 text-white placeholder-gray-400 rounded-tl-lg rounded-bl-lg bg-gray-700"/>
                ...
                <div>
                    <button type="button" onClick={handleSubmit}  className="h-14 w-60 sm:w-80 ml-1 text-white hover:shadow-xl rounded-lg bg-gradient-to-r from-purple-500 via-pink-500 to-red-500   hover:from-green-400 hover:to-blue-500">
                        <div className="flex justify-between items-center px-4">
                            <div><h1 className='text-white'>Login to Your Student's Account</h1></div>
