 ...
 const handleSubmit = async() => {
     ...
     if(form.code != ""){
         ...
         try{
            ...
            const response = await axios.post( `/api/group/${login._id}`, form, config)
              ...
              {/*body*/}
                  ...
                  <form className="h-full w-full space-y-2 ml-6 sm:px-5 my-10 sm:mr:10 justify-items-stretch sm:space-x-1 sm:grid md:grid:cols-2 lg:grid-cols-2 xl:grid-cols-3 3xl:flex flex-wrap justify-center">
                      ...
                      <div className="space-y-4" >
                          ...
                          <input type="text" placeholder="Enter group code" value = {form.code} onChange={handleChange} name= 'code'  className="h-16 w-54 text-indigo-500 font-bold  rounded-full px-3 bg-gray-200 shadow-md " />
                      </div>
