...
const handleChange =(e) => {
 ...
 const handleSubmit = async() => {
   ...
   if(form.groupname != "" || imagee != "" || image != "" || form.subjectname != ""){
    ...
    return (
        <div>
             <div
          className="justify-center px-3 h-screen w-screen items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none"
        >
                 ...
                 <div>
                  ...
                  <form className="h-full w-full space-y-2 ml-6 sm:px-5 my-10 sm:mr:10 justify-items-stretch sm:space-x-1 sm:grid md:grid:cols-2 lg:grid-cols-2 xl:grid-cols-3 3xl:flex flex-wrap justify-center">
                      ...
                      <div >
                          ...
                          <input type="text" value = {form.groupname} onChange={handleChange} name= 'groupname'  className="h-16 w-54 text-indigo-500 font-bold  rounded-full px-3 bg-gray-200 shadow-md " />
                      </div>
                      ...
                      <div>
                            ...
                            <div>
                                  <Input readonly="readonly" size="massive" transparent={false} list='subjects' placeholder='Choose a subject...'  name="subjectname" value={form.subjectname} onChange={handleChange}/>
                                  <datalist id="subjects">
                                        {
                                          login?.subject?.map((res)=> (
                                            <option value={`${res.subjectname}`}>
