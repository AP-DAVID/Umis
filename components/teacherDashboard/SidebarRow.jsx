    ...
    >
      {src && (
        <div className="flex space-x-3 mb-9">
          ...
          <p className="hidden sm:inline-flex font-medium text-blue-500">
            {" "}
            {srcTitle}{" "}
          </p>
        </div>
      ...
      <div
        className={
          active
            ? "bg-yellow-500 w-full flex space-x-3 py-2 px-4 rounded-xl"
            : "w-full flex space-x-3 py-2 px-2 rounded-xl"
        }
      >
        {Icon && (
