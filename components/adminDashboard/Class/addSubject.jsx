        ...
        <div className="relative w-full sm:w-2/3 my-auto mx-auto max-w-full px-2">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
              <h3 className="text-3xl font-semibold">Add Subjects</h3>
            </div>
            {/*body*/}
              ...
              <div>
                <Image
                  ...
                  src={
                    image
                      ? image
                      : "https://images.unsplash.com/photo-1588072432836-e10032774350?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8c2Nob29sfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                  }
                  bordered
                  size="small"
                />
                ...
                <label className="w-36 ml-3 flex flex-col items-center  bg-gray-600 rounded-xl shadow-md  uppercase border border-blue cursor-pointer hover:bg-blue-600 hover:text-white text-black ease-linear transition-all duration-150">
                  ...
                  <span className="mt-2 text-sm leading-normal px-2 text-white">
                    Select a Subject Picture
                  </span>
                  <input
                    type="file"
                    name="image"
                  ...
                  <div>
                    ...
                    <datalist id="teachers">
                      {data?.teachers?.map((res) => (
                        <option value={`${res.firstname}`}>Teachers</option>
                      ))}
