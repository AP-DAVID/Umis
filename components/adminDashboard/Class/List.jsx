...
function List({ setShowModal, setShowSubjects, login, data }) {
  ...
  return (
    <div>
      <div className="justify-center h-screen w-screen items-center flex scrollbar-hide overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
              ...
              {setShowSubjects && (
                <div className="pb-3">
                  <div
                    ...
                    className="px-2 py-4  pb-2 rounded-full cursor-pointer mb-3 fixed p-14  space-y-2 text-align group"
                  >
