      ...
      <tr key={student._id} className="text-gray-700">
        ...
        <td className="flex px-4 py-3 items-center space-x-3 text-sm border">
          ...
          <button
            ...
            className="bg-green-500 px-1 py-1 text-black hover:bg-blue-500 hover:text-white rounded-lg cursor-pointer"
          >
            Edit
          </button>

          <button className="bg-green-500 px-1 py-1 rounded-lg text-black hover:bg-blue-500 hover:text-white cursor-pointer">
            Delete
          </button>
        </td>
      </tr>
