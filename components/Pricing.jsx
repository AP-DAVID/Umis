...
function Pricing() {
  ...
  return (
    <div className="min-h-screen py-9 sm:py-2 text-gray-800">
      <div className="container p-4 lg:p-8 space-y-6 mx-auto">
        ...
        <div className="grid grid-cols-1 items-stretch  place-items-center md:grid-cols-3 gap-4 lg:gap-1">
            ...
            <div className="p-5 lg:p-6 bg-purple-500 space-y-5 lg:space-y-6 text-white rounded-b-lg">
              <ul className="space-y-4 text-sm lg:text-base">
                <li className="flex items-center space-x-2">
                  ...
                  <span>
                    <strong>Unlimited</strong> Database Maintenance
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                  ...
                  <span className="line-through">
                    <strong>Unlimited</strong> Maintenance{" "}
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                  ...
                  <span>
                    <strong>Unlimited</strong> Group Access
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                  ...
                  <span className="line-through">
                    <strong>Unlimited</strong> Chat Access
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
              ...
              <a
                ...
                className="px-4 py-3 text-white text-center uppercase font-semibold rounded-2xl bg-gray-700 hover:bg-gray-900 block w-full"
          ...
          <div className="rounded-2xl cursor-pointer w-72  shadow-2xl bg-red-300 flex flex-col">
            <div className="p-5 lg:p-6 text-center flex-grow">
              ...
              <p className="text-gray-600">Best plan for a medium budget</p>
            </div>
            <div className="p-5 lg:p-6 bg-red-300 space-y-5 lg:space-y-6 text-gray-700 rounded-b-lg">
              <ul className="space-y-4 text-sm lg:text-base">
                <li className="flex items-center space-x-2">
                  ...
                  <span>
                    <strong>Unlimited</strong> Database access
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                  ...
                  <span>
                    <strong>3 months</strong> Maintenance
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg
                ...
                <li className="flex items-center space-x-2">
                  <svg
                    className="text-yellow-500 w-5 h-5 inline-block"
                    fill="none"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth="2"
          ...
          <div className="rounded-2xl cursor-pointer w-72 shadow-sm bg-blue-500 flex flex-col ">
            <div className="p-5 lg:p-6 text-center text-white flex-grow">
              ...
              <p>Best plan for a higher budget</p>
            </div>
