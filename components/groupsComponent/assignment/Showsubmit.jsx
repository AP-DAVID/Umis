...
function Showsubmit({
  ...
  return (
    <div className="px-5">
      <div className="justify-center px-3 h-screen py-2 w-screen items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        ...
        <div className="relative w-full sm:w-2/3 my-auto mx-auto max-w-full">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex justify-end items-center">
                {index === -1 ? (
                  <div className="space-x-2 flex items-center px-3">
                    {data?.mark && (
                      <h1 className="text-lg text-black border-2 border-blue-500 rounded-full px-2 py-2 font-bold">
                        {data?.mark}
                      </h1>
                    )}
                    ...
                    {data.mark ? (
                      ...
                      <h1 className="text-lg text-black font-bold">Score</h1>
                    )}
                    ...
                    <InputNumber
                      ...
                      name="mark"
                      type="number"
                      className=" px-2  h-10 border-2 border-red-500  rounded-md"
                      min={0}
                      max={parseInt(details?.totalmark)}
                      defaultValue="score"
                    />
                  </div>
                ) : (
              ...
              <h1 className="text-gray-600 px-2 text-base">{date}</h1>
            </div>
