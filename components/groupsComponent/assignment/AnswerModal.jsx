...
function Modalass({setOpenModal, openModal, title, body, assignId, studentId}) {
  ...
  const handleSubmit = async() => {
    ...
    if(dataa != ""){
      ...
      try{
        ...
        const response = await axios.post(`/api/assign/${assignId}`, form, config);
            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              {/*body*/}
                  ...
                  <form onSubmit={handleSubmit} className="px-4 py-2">
                                ...
                                <div className="mb-8">
                                    <label className="text-xl text-gray-600"><Interweave className="mr-3 line-clamp-2" tagName="div" content={body} /> <span className="text-red-500">*</span></label><br />
                                ...
                                {showModal && <ConfirmModal text1="Assignment has been submitted Successfully " setShowModa = {setShowModal}/>}
