...
function Cardc({ name, text, data, picture, section, login }) {
  ...
  return (
    <div
      ...
      className="border-2 w-full overflow-auto  py-3 mb-2 shadow-md rounded-md  break-all"
    >
      <div className="flex space-x-4 ml-3 break-all">
        <div className="flex flex-col cursor-pointer space-y-2l break-all object-contain">
          <h1 className="font-bold flex items-center space-x-3 px-2 text-base">
            <img
              src={
                picture
                  ? picture
                  : "https://media.istockphoto.com/photos/success-happens-the-moment-you-believe-it-will-picture-id1262964438?b=1&k=20&m=1262964438&s=170667a&w=0&h=rgmdwXyMrmNuY_3BlmBFI0MdeayurqAjQSvweG4Htso="
              }
              className="h-9 mr-2 relative w-9 object-cover rounded-full"
            />
            {name}
          ...
          <h1
            ...
            } font-medium text-base break-all`}
          >
            {text}
          </h1>
        </div>
