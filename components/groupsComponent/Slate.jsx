    ...
    <>
      <div className=" border  w-full rounded-lg  ">
        ...
        <div className="flex space-x-3 px-4 text-gray-600 items-center">
          <Interweave
            className={`mr-3 ${!openn ? "line-clamp-5" : "line-clamp-none"}`}
            tagName="div"
            content={text}
          />
        ...
        <div
          ...
          className="border-2 rounded-md cursor-pointer hover:border-red-500 h-full mt-2 py-2 w-full border-blue-500"
        >
          <h1 className="text-purple-500 hover:text-red-500 font-medium px-12">
            Add class comment
          </h1>
        </div>
      </div>
