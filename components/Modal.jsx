...
export default function Modal({ showModal, setShowModal, amount }) {
  ...
  const sendEmail = async () => {
    ...
    await setToSend(
      (toSend.message = `Your username is : ${userLog} and your password is : ${passwordLog}, you can log in to your admin panel with the credentials`)
    );
  ...
  const componentProps = {
    ...
    onSuccess: () => {
      alert(
        `We have sent the username and password for your admin login to your email address`
      );
      setShowWait(true);
          ...
          <div className="justify-center text-white items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-sm">
              ...
              <div className="border-0 rounded-lg shadow-lg relative text-white flex flex-col w-full bg-purple-500 outline-none focus:outline-none">
                ...
                {showWait && <Wait showWait={showWait} />}
