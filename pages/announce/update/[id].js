...
function Updateblog({dataa}) {
    ...
    const handleSubmit= async() =>{
     ...
     if(form2.file != "") {
        ...
        await setForm(form.body = data)
            ...
            try{
                const response = await axios.put(`/api/announce/${id}`, JSON.stringify(form) , config)
                setOpen(false)
                setShowModal(true)
    ...
    return (
        <div className="bg-gray-400 h-screen">
            ...
            {session && (<div className="py-12 text-black bg-gray-400">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <input 
                                        ...
                                        type="text" className="border-2 text-black border-gray-300 p-2 w-full" name="title" id="title" />
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        name= 'desc'
                                        onChange={handleChange} 
                                        type="text" className="border-2 text-black border-gray-300 p-2 w-full"  id="desc"/>
                                </div>
                                ...
                                {showModal && <ConfirmModal own text1 = "Blog post updated" setShowModal = {setShowModal}/>}
